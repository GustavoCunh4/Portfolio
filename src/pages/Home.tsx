        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in-up">
            ...
            <div className="text-center lg:text-left">
              <div className="inline-block relative bg-white/10 backdrop-blur-lg rounded-2xl p-4 shadow-2xl border border-white/10 animate-fade-in-up">
                <img
                  ...
                  className="w-48 h-48 rounded-full mx-auto lg:mx-0 object-cover shadow-2xl border-4 border-[#ff6f61]"
                  onError={(e) => {
                ...
                />
                <div className="absolute -bottom-2 -right-2 w-16 h-16 bg-gradient-to-br from-[#ff6f61] to-[#23234a] rounded-full flex items-center justify-center text-white text-2xl animate-pulse border-4 border-white">
                  👨‍💻
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a
                href="/projects"
                className="inline-flex items-center justify-center px-6 py-3 text-lg bg-gradient-to-r from-[#ff6f61] to-[#23234a] hover:from-[#ff8c7a] hover:to-[#23234a] text-white font-bold rounded-full shadow-lg hover:scale-105 transition-all duration-300"
              >
              ...
              <a
                href="#contato"
                className="inline-flex items-center justify-center px-6 py-3 text-lg bg-gradient-to-r from-[#23234a] to-[#ff6f61] hover:from-[#23234a] hover:to-[#ff8c7a] text-white font-bold rounded-full shadow-lg hover:scale-105 transition-all duration-300"
              >
                <span className="mr-2">📧</span>
                Entrar em Contato
              </a>
